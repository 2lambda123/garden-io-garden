...
FROM node:22.3.0-alpine@sha256:415f3219943ef82fa45988acdaa7df05a0b52cabd3502095c59d34cbe28c1bc1 as garden-base-root
...
FROM python:3.12-alpine@sha256:ef097620baf1272e38264207003b0982285da3236a20ed829bf6bbf1e85fe3cb AS aws-builder
...
# gcloud base
#
FROM google/cloud-sdk:481.0.0-alpine@sha256:72e2ce0866cfa0572ee5e74f1b51f17c346e5d4a412644cab49de0df326db50f as gcloud-base
